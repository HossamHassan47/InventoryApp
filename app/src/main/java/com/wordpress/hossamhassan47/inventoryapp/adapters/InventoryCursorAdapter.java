...
public class InventoryCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        // Find views
        TextView txtProductName = view.findViewById(R.id.text_view_product_name);
        TextView txtPrice = view.findViewById(R.id.text_view_price);
        TextView txtQuantity = view.findViewById(R.id.text_view_quantity);
        ImageView btnSale = view.findViewById(R.id.image_view_sale);
        ImageView btnEdit = view.findViewById(R.id.image_view_edit);
        ...
        txtPrice.setText(String.format("%s %s%d", context.getString(R.string.list_item_price), context.getString(R.string.list_item_currency), price));
        txtQuantity.setText(String.format("%s %d", context.getString(R.string.list_item_quantity), quantity));
